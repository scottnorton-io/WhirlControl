...
class RecJamFeed:
    ...
    def to_csv(self) -> str:
        """Serialize feed items to CSV string."""
        import csv
        import io
    ...
    @classmethod
    def from_csv(cls, data: str) -> "RecJamFeed":
        """Create a RecJamFeed from CSV string generated by :meth:`to_csv`."""
        import csv
        import io
